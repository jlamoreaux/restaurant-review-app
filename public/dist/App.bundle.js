...
function autocomplete(input, latInput, lngInput) {
    if (!input) return; // skip this fn from running if no input
...
var mapOptions = {
    ...
    /*
    // TRY TO REPLACE STATIC LAT LNG W/ CURRENT USER POSITION
...
function typeAhead(search) {
    ...
    searchInput.on('keyup', function (e) {
        // if they aren't pressing an up, down or enter key, skip it
